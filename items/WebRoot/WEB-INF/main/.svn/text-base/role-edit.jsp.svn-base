...
<form name="form2" action="${pageContext.request.contextPath}/role/role_editsave.do" method="post" id="form2">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input value="${roleInfo.r_name }" id="r_name" name="r_name"/>
	</td>
</tr>
<tr >
...
<tr >
	...
	<td colspan=3 align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" >
		<textarea rows=10 cols=130 name="r_comment" id="r_comment">${roleInfo.r_comment}</textarea>
	</td>
</tr>
...
<td height="28" colspan=4 align=center>
	&nbsp;
	<input type="text" name="r_id" hidden="hidden" value="${roleInfo.r_id }">
