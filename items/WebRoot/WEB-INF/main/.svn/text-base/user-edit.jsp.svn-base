...
<form id="form2" name="form2" action="${pageContext.request.contextPath}/role/saveEditUser.do" method="post">
...
<tr>
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
	<input type="text" name="e_name" id="e_name" value="${employee.e_name }"/>
<input type="text" name="e_id" id="e_id" value="${employee.e_id }" hidden="hidden" > 
	</td>
</tr>
<tr >
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input type="text" name="e_age" id="e_age" value="${employee.e_age}"/></td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">联系电话：</td>
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input type="text" name="e_phone" id="e_phone" value="${employee.e_phone }"/></td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">入职时间：</td>
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input type="text" name="e_startdate" id="e_startdate" value="${employee.e_startdate }"/></td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">身份证号码：</td>
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input type="text" name="e_idcard" id="e_idcard" value="${employee.e_idcard }"/></td>
</tr>
<tr >
...
<tr >
	...
	<td colspan=3 align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" >
		<textarea rows=10 cols=130 name="e_comment" id="e_comment">${employee.e_comment  }</textarea>
	</td>
</tr>
